...
public class train_c45 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int split_index = 1;split_index<=10;split_index++) {
            ...
            String path = "src/main/Data/weka_10fold/org_data.csv";
            deal_data(path,ks);
            ...
            for (int fold_index = 1; fold_index <= 5; fold_index++) {
                ...
                String path_train = "src/main/Data/weka_10fold/split_"+split_index+"/fold_"+fold_index+"/train.csv";
                ...
                String path_test = "src/main/Data/weka_10fold/split_"+split_index+"/fold_"+fold_index+"/test.csv";
